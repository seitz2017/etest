      ...
      //팔라딘이 선택된 경우
            ...
            while(timer.day() < 10) {
                  ...
                  Loop1: while( (timer.day()) < 10) {
                     ...
                     System.out.println("불스킬 능력치: " + hero.fire);
                     System.out.println();
                     //이동 경로 선택
...
//                              }
                              ...
                              if(monster instanceof Goblin) {
                            	  ...
                            	  while(orc.hp > 0) {
                                  	...
                                  	//마이너스 체력 영으로 처리
                               		 if(hero.hp<0 && orc.hp<0) {
                               			System.out.println("player의 hp: 0");
                                         System.out.println("player의 mp: "+hero.mp);
                                         System.out.println("player의 lockdown: "+hero.lockdown);
                                         System.out.println(orc.name+"의 hp: 0");
                                         System.out.println("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
                               		 }else if(hero.hp>0 && orc.hp<0) {
                               			System.out.println("player의 hp: "+hero.hp);
                                         System.out.println("player의 mp: "+hero.mp);
                                         System.out.println("player의 lockdown: "+hero.lockdown);
                                         System.out.println(orc.name+"의 hp: 0");
                            	  ...
                            	  while(ogre.hp > 0) {
                                  	...
                                  	//마이너스 체력 영으로 처리
                                  		 if(hero.hp<0 && ogre.hp<0) {
                                            ...
                                            System.out.println("player의 mp: "+hero.mp);
                                            System.out.println("player의 lockdown: "+hero.lockdown);
                                            System.out.println(ogre.name+"의 hp: 0");
                                            System.out.println("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
                                  		 }else if(hero.hp>0 && ogre.hp<0) {
                                  			System.out.println("player의 hp: "+hero.hp);
                                            System.out.println("player의 mp: "+hero.mp);
                                            System.out.println("player의 lockdown: "+hero.lockdown);
                                            System.out.println(ogre.name+"의 hp: 0");
                            	  ...
                            	  while(wyvern.hp > 0) {
                                  	...
                                  	//마이너스 체력 영으로 처리
                                 		 if(hero.hp<0 && wyvern.hp<0) {
                                 			System.out.println("player의 hp: 0");
                                           System.out.println("player의 mp: "+hero.mp);
                                           System.out.println("player의 lockdown: "+hero.lockdown);
                                           System.out.println(wyvern.name+"의 hp: 0");
                                           System.out.println("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
                                 		 }else if(hero.hp>0 && wyvern.hp<0) {
                                 			System.out.println("player의 hp: "+hero.hp);
                                           System.out.println("player의 mp: "+hero.mp);
                                           System.out.println("player의 lockdown: "+hero.lockdown);
                                           System.out.println(wyvern.name+"의 hp: 0");
                        ...
                        System.out.println("2. lockdown(가격:2500, 타겟의 공격을 1초동안 마비, 레벨5이상 구입 가능)");
                        
                        System.out.println("구매할 물건을 선택하세요");
                        System.out.println("3. 잊혀진신전 나가기");
                        number = sc.nextInt();
                        if(number == 3)
                           break Loop1;
                        int temp = hero.money;
                                   ...
                                   while(hero.hp >0 && dragon.hp > 0) {
                                   	...
                                   	//마이너스 체력 영으로 처리
                                 		 if(hero.hp<0 && dragon.hp<0) {
                                           ...
                                           System.out.println("player의 mp: "+hero.mp);
                                           System.out.println("player의 lockdown: "+hero.lockdown);
                                           System.out.println(dragon.name+"의 hp: 0");
                                           System.out.println("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
                                 		 }else if(hero.hp>0 && dragon.hp<0) {
                                 			System.out.println("player의 hp: "+hero.hp);
                                           System.out.println("player의 mp: "+hero.mp);
                                           System.out.println("player의 lockdown: "+hero.lockdown);
                                           System.out.println(dragon.name+"의 hp: 0");
                                         ...
                                         /* System.out.println("player의 hp: "+hero.hp);
                                          ...
                                          System.out.println("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
                                          System.out.println("========================아이템 'lockdown'사용으로 타겟이 마비 되었습니다==========================");
                                          hero.itemuse(1);
...
//                              }
                    	...
                    	if(sum!=0) {
                    		...
                    		//hp
                    		if(number == 4)
                    		hero.hp = inventory.inventory_use_hpPotion(number, cnt, hero.hp);
                    		//mp
                    		if(number == 5)
                    		hero.mp = inventory.inventory_use_mpPotion(number, cnt, hero.mp);
                    		//불화살(대용량)
                    		if(number == 6)
                    		hero.fire = inventory.inventory_use_magicBig(number, cnt, hero.fire);
